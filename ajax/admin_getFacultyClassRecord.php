...
?>
        <div class="panel panel-default">
            <div class="panel-heading">
                Class Record for <strong><span style='color:green; text-transform: uppercase !important;'><?php echo $class_row['class_code']; ?> <span class='fa fa-angle-double-right'></span> <?php echo $class_row['subject']; ?></strong> </span>
            </div>
